...
**Version 0.4-prelim + T88E · 2026-09-04 · ~1,150 words**

**Standing version: v0.4-prelim+T88E** (DAMPE + Zhang+2025 LSS + T88.C Euclid Q1 lensing + T88.E Euclid Q1 subhalo FORECAST joint-fit rerun; v0.8 result). Channels: **22 effective**; **Tests: 662 pass, 8 skip** (post-T88.C: Euclid Q1 strong-lensing Channel 23 silent cross-check at v0.7; +T88.E Euclid subhalo dN/dM FORECAST Channel 24; +36 new tests; T88.E is the FIRST NON-SILENT channel of T88 series with -0.85 pure contribution at v0.7 MAP after sampling-variance control test). Tests: **542 pass** / 0 fail / 6 skip (T72: 446 → T74: 472 → T81: 504 → T83: 523 → T84: 542). V0_6_ROADMAP: 9 of 15 items shipped (3 partial-closure: #10, #17, #19) + 2 v0.4-prelim Tier-1 extensions (DAMPE, LSS) + 1 v0.4-prelim Tier-1 watch channel (XENONnT+PandaX, T81 2026-09-02) + 1 KSFR LATTICE-class promotion (T83: (3,2) fundamental) + 1 Channel 18 sensitivity study (T84) + 1 v0.8 release (T88.E FORECAST, 2026-09-04).
