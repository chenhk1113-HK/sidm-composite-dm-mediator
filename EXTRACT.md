...
**Standing version: v0.4-prelim+T75** (DAMPE + Zhang+2025 LSS joint-fit rerun; v0.7 result). Channels: **19** (was 16; +2 Tier-1 DAMPE+LSS, +1 Channel 19 XENONnT/PandaX watch, T81 2026-09-02). Tests: 504 pass / 0 fail / 6 skip. V0_6_ROADMAP: 9 of 15 items shipped (3 partial-closure: #10, #17, #19) + 2 v0.4-prelim Tier-1 extensions (DAMPE, LSS) + 1 v0.4-prelim Tier-1 watch channel (XENONnT+PandaX, T81 2026-09-02).
