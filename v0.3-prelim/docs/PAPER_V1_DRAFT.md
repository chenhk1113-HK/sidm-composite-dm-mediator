...
**physical reason is NOT primarily kinematic**. Per the corrected T199
...
is N ≈ 1.01×10⁻⁵³ (53 orders below observed 1 event). **Earlier versions
of this section (v18.13-v18.14) had a bug in the v_min formula** (used m_χ²
in denominator instead of μ²); the corrected formula gives v_min = 591 km/s,
not 1096 km/s. See T199 for the corrected calculation. For detectors with lower E_R thresholds (DarkSide-20k's
