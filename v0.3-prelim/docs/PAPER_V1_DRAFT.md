...
**(b) Fresh T196 test against v18.11 posteriors (T192 Drobczyk candidate, m_χ = 10.3 GeV, g_h_SM = 0.00040, σ_SI = 2×10⁻⁴⁹ cm²):** script `v0.3-prelim/code/T196_v18_lz_event_rate.py` initially gave N_events ≈ 4.35×10⁻²⁹ (28.36 orders deficit) but this calculation **omitted the kinematic threshold check**. The comprehensive T197 analysis (`v0.3-prelim/code/T197_deep_lz_analysis.py`) reveals that **at m_χ = 10.3 GeV, v_min at E_R = 5.4 keV is 1096 km/s, exceeding the SHM escape velocity + lab motion of 776 km/s**. Therefore v18.11 produces **0 events at LZ regardless of σ_SI** in the 5.4-270 keV window. The T187 benchmark σ_SI = 1.23×10⁻⁴⁶ at 10 GeV (cited in §10 as "RIGHT AT LZ SENSITIVITY") assumed the LZ 2023 low-E analysis (~1 keV threshold), not the 2026 extended-window analysis that produced the 248 keV event. **This is a paper-relevant correction** that should be flagged in §10.5a.

**(c) Di Mauro 2026 INELASTIC interpretation (m_χ = 1 TeV, δ = 297 keV, σ_inel = 6.5×10⁻⁴³ cm²):** tested with the project's T87 kinematic formula (v_min = sqrt(2 m_χ δ + 2 m_N E_R) / m_χ). Result: **N_events ≈ 2.04×10⁻⁴² at LZ** (41.7 orders below observed 1 event). Kinematically ACCESSIBLE (v_min ~ 232 km/s at 5.4 keV, well within SHM). Cross-detector: PandaX-4T gives 1.19×10⁻⁴², XENONnT gives 6.33×10⁻⁴³. **Di Mauro's interpretation predicts too few events by 42 orders** at all xenon detectors. **Note**: the Tucker-Smith & Weiner 2001 PRD 64, 043502 formula gives a stricter v_min (~12000+ km/s) for δ >> E_R × m_N/m_χ; the T87 formula is the project standard for inelastic kinematics.
