...
**(b) Fresh T196 test against v18.11 posteriors (T192 Drobczyk candidate, m_χ = 10.3 GeV, g_h_SM = 0.00040, σ_SI = 2×10⁻⁴⁹ cm²):** script `v0.3-prelim/code/T196_v18_lz_event_rate.py` initially gave N_events ≈ 4.35×10⁻²⁹ (28.36 orders deficit). The corrected analysis (T199, `v0.3-prelim/code/T199_corrected_lz_analysis.py`) uses the standard Lewin-Smith 1996 elastic v_min formula `v_min = c × sqrt(m_N × E_R / (2 × μ²))` where `μ = m_χ × m_N / (m_χ + m_N)` (NOT the `m_χ²` in denominator used in T196/T197, which was a bug). At m_χ = 10.3 GeV, E_R = 5.4 keV, m_N = 131 GeV: **v_min = 591 km/s**, which IS below the SHM escape velocity + lab motion threshold of 776 km/s. Therefore v18.11 IS kinematically accessible, but produces only **N_events ≈ 1.01×10⁻⁵³ at LZ** (53.0 orders below the observed 1 event) due to the small σ_SI = 2×10⁻⁴⁹ cm². The T187 benchmark σ_SI = 1.23×10⁻⁴⁶ at 10 GeV (cited in §10 as "RIGHT AT LZ SENSITIVITY") assumed the LZ 2023 low-E analysis (~1 keV threshold), not the 2026 extended-window analysis that produced the 248 keV event.

**(c) Di Mauro 2026 INELASTIC interpretation (m_χ = 1 TeV, δ = 297 keV, σ_inel = 6.5×10⁻⁴³ cm²):** tested with the correct **TS&W 2001 PRD 64, 043502 v_min formula** (NOT the T87 doc's approximate formula, which was a bug): `v_min = sqrt((m_χ δ + m_N E_R)² / (2 m_χ m_N E_R)) × c`. Result: **v_min = 75087 km/s at E_R = 5.4 keV**, which is **96.7× the SHM threshold**. Therefore Di Mauro 2026 is **KINEMATICALLY INACCESSIBLE** at LZ and produces **0 events** at LZ, PandaX-4T, XENONnT, DarkSide-20k, and DARWIN regardless of σ_inel. The TS&W 2001 formula is the correct one for endothermic inelastic scattering when δ >> E_R × m_N/m_χ (here δ = 297 keV dominates recoil × m_N/m_χ = 32.5 keV by 9.1×).

**Comparison:** Three models, three failures:
- v0.7 composite-DM (T87): kinematically accessible, σ_DM_nuc too small — fails by **115 orders** at LZ
- v18.11 Drobczyk (T196/T197): kinematically **INACCESSIBLE** at LZ 5.4-270 keV window — produces 0 events regardless of σ_SI
- Di Mauro 2026 inelastic (T197): kinematically accessible via T87 formula, σ_inel too small — fails by **42 orders** at LZ
...
[15b] A. Benítez-Llambay, R. Dutta, M. Fumagalli, J. F. Navarro, "Examining the Nature of the Starless Dark Matter Halo Candidate Cloud-9," Astrophys. J. 973, 61 (2024)hys. J. 973, 61 (2024).
