...
> **Status:** v18.43 (2026-09-26) — **T215 KiSS-SIDM real N-body IC + gravothermal**. T215 IC generator produces 10⁴-particle virialized NFW halo (v_rms = 33 km/s = V_max = 31.12 km/s, proper virialization). KiSS-SIDM runs at σ/m = 70 cm²/g show 23% density decrease at r = r_s over 24 Myr — consistent with gravothermal core expansion (isothermal core formation, Kaplinghat+ 2016), not collapse. Balberg+ t_core = 0.176 Gyr remains untested directly. Silent Julia process crashes at >25 Myr simulated time are likely GC pressure on adaptive grid; reducing particle count from 10⁴ to 3000 enables 26 Myr run. See [`docs/T215_KISS_SIDM_CLOUD9_GRAVOTHERMAL_2026-09-26.md`](docs/T215_KISS_SIDM_CLOUD9_GRAVOTHERMAL_2026-09-26.md) for the full T215 doc. v18.40 T212 refinements (Path A3 + Path B3 trim), v18.41 2review.docx response (abstract compression, headline retirement, T209 NFW sampling bug fix, T210 justifications), and v18.42 T175/T213 verification (KK tower + Silverman+ combined test) all preserved.
