# =============================================================================
# THIS FILE IS A FROZEN SNAPSHOT OF THE CANONICAL CONFIG (2026-09-12).
# DO NOT EDIT THIS FILE.
#
# The CANONICAL (live, mutable) config is at the project root:
#     C:/Users/lamkuenai/projects/sidm-composite-dm-mediator/config.py
#     (or in WSL: /mnt/c/Users/lamkuenai/projects/sidm-composite-dm-mediator/config.py)
#
# Why this snapshot exists:
#     Some scripts in v0.3-prelim/code explicitly do:
#         sys.path.insert(0, ".../v0.3-prelim/code")
#         import config
#     expecting to find a local config module. Deleting this file would break
#     those scripts. So it's preserved as a snapshot.
#
# Why you should NOT edit this file:
#     Python's import system uses sys.path priority. When the project root
#     is on sys.path (which it is for most tests and tools), Python imports
#     the project-root config.py first. Edits to THIS file have NO EFFECT
#     on runtime behavior — only the project-root file does.
#
# If you need to change a constant:
#     1. Edit the project-root config.py (the canonical one).
#     2. Either:
#        a. Synchronize this snapshot to match (recommended for tracked changes),
#           OR
#        b. Run tests/test_config_snapshot_consistency.py to verify the
#           divergence is intentional. The test will FAIL until either:
#           - This snapshot is updated to match, OR
#           - The divergence is acknowledged in the test's allowlist.
#
# See:
#     - v0.3-prelim/docs/CONFIG_DUPLICATION_2026_09_12.md (the design note)
#     - tests/test_config_snapshot_consistency.py (the consistency check)
# =============================================================================
