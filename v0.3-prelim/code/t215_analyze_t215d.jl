...
const SNAP_DIR = "/mnt/c/Users/lamkuenai/projects/sidm-composite-dm-mediator/v0.3-prelim/data/snapshots_t215d"
const OUT_PATH = "/mnt/c/Users/lamkuenai/projects/sidm-composite-dm-mediator/v0.3-prelim/data/results/t215_density_profiles_t215d.json"
const R_S_PC = 2924.4
...
println()
println("Density at interior r = 500 pc:")
for p in profiles
...
println()
println("Density at very small r = 200 pc:")
for p in profiles
    idx = argmin(abs.(p["r_bins_pc"] .- 200.0))
    @printf "  t=%6.3f Myr: rho(200pc)=%.4e Msun/pc^3\n" p["t_myr"] p["rho_Msun_pc3"][idx]
end
