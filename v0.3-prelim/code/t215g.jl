#!/usr/bin/env julia
# T215g — Push past 60 Myr with frequent GC and longer target
...
println("=" ^ 60)
println("T215g — Push past 60 Myr with frequent snapshots")
println("=" ^ 60)
...
# Target: 120 Myr total (68% of Balberg t_core) with frequent snapshots
# Also try adaptive_grid_min_particles=32 (smaller cells, smoother)
t_end_Gyr = 0.12
snapshot_times = collect(range(0.0u"Gyr", stop=t_end_Gyr * u"Gyr", length=25))  # every 5 Myr
...
println("Running $n_tracer particles, target t_end=$t_end_Gyr Gyr (120 Myr)")
println("Snapshots: 25 (every ~5 Myr)")
...
out_path = "/mnt/c/Users/lamkuenai/projects/sidm-composite-dm-mediator/v0.3-prelim/data/results/t215g_summary.json"
