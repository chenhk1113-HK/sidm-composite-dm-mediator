...
def main():
    ...
    out_path = Path("/home/lamkuenai/sidm-composite-dm-mediator/v0.3-prelim/data/results/t36b_5config_c_vir_sweep.json")
    out_path.parent.mkdir(parents=True, exist_ok=True)
    out_path.write_text(json.dumps(out, indent=2, default=str))
    win_path = Path("/mnt/c/Users/lamkuenai/projects/sidm-composite-dm-mediator/v0.3-prelim/data/results/t36b_5config_c_vir_sweep.json")
