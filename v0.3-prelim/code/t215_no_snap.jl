#!/usr/bin/env julia
# T215_no_snap — Test: disable frequent snapshots to see if that prevents the crash.
# Hypothesis: JLD2 snapshot writes are triggering the silent Julia crash.
...
println("=" ^ 60)
println("T215_no_snap — KiSS-SIDM with MINIMAL snapshots")
...
# KEY CHANGE: only 2 snapshots (start and end) — minimize JLD2 writes
t_end_Gyr = 0.10  # 100 Myr = 57% of Balberg t_core
snapshot_times = [0.0u"Gyr", t_end_Gyr * u"Gyr"]  # Just 2 snapshots
...
out_path = "/mnt/c/Users/lamkuenai/projects/sidm-composite-dm-mediator/v0.3-prelim/data/results/t215_no_snap_summary.json"
